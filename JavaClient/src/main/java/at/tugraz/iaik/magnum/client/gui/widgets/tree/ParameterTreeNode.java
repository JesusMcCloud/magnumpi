...
public class ParameterTreeNode extends ClassTreeDefaultNode {
  private static final long serialVersionUID = 6306572036591293374L;
  private final TypeModel parameterType;

  public ParameterTreeNode(final TypeModel parameterType) {
    this.parameterType = parameterType;
    setText(parameterType.getClassName());
  }
  ...
  public Component getIcon() {
    ...
    return new JLabel(parameterType.getClassName(), icon, SwingConstants.LEFT);
  }
}