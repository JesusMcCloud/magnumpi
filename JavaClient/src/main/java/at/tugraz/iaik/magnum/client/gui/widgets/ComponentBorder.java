...
/**
 * TAKEN FROM http://www.camick.com/java/source/ComponentBorder.java The
 * ComponentBorder class allows you to place a real component in the space
...
public class ComponentBorder implements Border {
   ...
   *          a valid Edge enum of TOP, LEFT, BOTTOM, RIGHT
   * @param alignment
   *          the alignment of the component along the specified Edge. Must be
   *          in the range 0 - 1.0.
   */
  ...
  /**
   * In this case a real component is to be painted. Setting the location of the
   * component will cause it to be painted at that location.
   */
  ...
  /**
   * The insets need to be determined so they are included in the preferred size
   * of the component the Border is attached to.
   * 
   * The alignment of the component is determined here so it doesn't need to be
   * recalculated every time the Border is painted.
   */
  ...
  /*
   * The complimentary edges of the Border may need to be adjusted to allow the
   * component to fit completely in the bounds of the parent component.
   */
