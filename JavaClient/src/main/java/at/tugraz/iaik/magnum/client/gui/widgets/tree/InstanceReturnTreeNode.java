...
public class InstanceReturnTreeNode extends ClassTreeDefaultNode {
  private static final long serialVersionUID = -4008312706162743301L;
  private final InstanceModel returnObject;

  public InstanceReturnTreeNode(InstanceModel returnObject) {
    this.returnObject = returnObject;
    constructTypeDetailNodes();
  }

  private void constructTypeDetailNodes() {
    FormattedInstanceNodeFactory.format(this, returnObject.getData());
  }
